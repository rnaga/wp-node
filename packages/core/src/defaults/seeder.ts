...
export namespace sitemeta {
  export const emailSiteWelcome = `Howdy USERNAME,
...
export namespace content {
  export const commentContent = `Hi, this is a comment.
To get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.`;

  export const firstPost = `<!-- wp:paragraph -->\n<p>
Welcome to WordPress. This is your first post. Edit or delete it, then start writing!
</p>\n<!-- /wp:paragraph -->`;

  export const firstPage = `<!-- wp:paragraph -->
<p>
...
<!-- wp:paragraph -->`;
  ...
  export const sidebarsWidgets = {
    wp_inactive_widgets: [],
    "sidebar-1": ["block-2", "block-3", "block-4"],
    "sidebar-2": ["block-5", "block-6"],
    array_version: 3,
  };
}
